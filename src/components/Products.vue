    ...
    hover:scale-105">
                        ...
                        <article>
                            <figure>
                                ...
                                " class="absolute top 3 right bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full ">
                                    -{{ product.discount }}%
                                </figcaption>
                                <button
                                ...
                                <footer class="flex items-center justify-between">
                                    ...
                                    <div>
                                        ...
                                        <span v-if="product.discount > 0"
                                            class="text-sm text-gray-500 line-throught ml-2">
...
:class="['w-3 h-3 rounded-full' , currentSlide=== index-1? 'bg-pink-950' : ng-gray-400]"/>
            </nav>
        </main>
...
const products = [
    ...
    { id: 2, name: 'Oriental', price: 199.99, rating: 4.2, image: '../assets/product1.png', discount: 15 },

    { id: 3, name: 'Woody', price: 79.99, rating: 4.7, image: '../assets/product2.png', discount: 10 },

    { id: 4, name: 'Floral', price: 99.99, rating: 4.5, image: '../assets/product3.png', discount: 0 },

    { id: 5, name: 'Floral', price: 99.99, rating: 4.5, image: '../assets/product4.png', discount: 25 },

    { id: 6, name: 'Floral', price: 99.99, rating: 4.5, image: '../assets/product5.png', discount: 5 },

    { id: 7, name: 'Floral', price: 100.99, rating: 4.5, image: '../assets/product6.png', discount: 5 },

    { id: 8, name: 'Floral', price: 99.99, rating: 4.5, image: '../assets/product7.png', discount: 5 },
]
